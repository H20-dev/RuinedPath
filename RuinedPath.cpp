...
namespace FileOperation {
	...
	struct SaveData {
		...
		bool deserialize(const vector<uint8_t>& buf) {
			...
			if (!readRaw(&speed, sizeof(speed))) return false;
